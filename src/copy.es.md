# Texto del sitio (español de Costa Rica)

Este archivo es la fuente del texto. `python src/build.py` lo lee y arma las tres rutas.
Edite solo lo que está **después de los dos puntos**. No cambie las llaves de la izquierda.
Se permite HTML sencillo dentro del texto (`<b>`, `&mdash;`, `&times;`).

Tratamiento: ustedeo. Nunca voseo ni tuteo. Cuando se pueda, infinitivo o impersonal.

## Encabezado y navegación

nav.skip: Ir al contenido
nav.workshop: El taller
nav.learn: Más información
cta.whatsapp: Escríbanos por WhatsApp
cta.book: Reservar medio día
...
learn.claim2: Solo 9% tienen una política formal de IA.
learn.means2: Casi nadie ha escrito qué puede salir de la empresa ni quién revisa qué. Esa es la parte que se arregla en una tarde.
learn.claim3: Solo al 47% de las personas empleadas se les ha dado alguna capacitación en IA.
learn.means3: Más de la mitad de quienes usan IA en el trabajo nunca recibieron enseñanza. Pregunte en su oficina.
learn.claim4: Quienes empiezan y reciben enseñanza hacen hasta 34% más.
learn.means4: Las mayores ganancias son para quienes empiezan y reciben enseñanza. Ese es su equipo. Ese es el medio día.
learn.cta.big: Medio día. Sus archivos. Nada que comprar después.
learn.also.h3: También vale la pena leer

## También vale la pena leer

also1: Empresas tecnológicas costarricenses que ya usan IA generativa o agentes digitales en su operación
also2: Empresas tecnológicas costarricenses que redujeron el tiempo de desarrollo de producto con IA
also3: Costa Rica como líder de América Latina en talento humano para IA
also4: Empleos en Costa Rica expuestos en teoría a la automatización con modelos de lenguaje
also5: Distancia entre lo que la IA podría hacer en teoría y lo que se usa en la práctica en el trabajo de oficina
also6: Organizaciones que usan IA de forma habitual en al menos una función del negocio
also7: Pilotos de IA generativa en empresas que no muestran efecto en resultados financieros
also8: Creencia global de que la IA va a reducir el empleo
also9: Personas que llevan su propia IA al trabajo, por fuera de las herramientas de la empresa
also10: Organizaciones que reportan uso de IA en al menos una función, según el índice de Stanford
also11: Personas que trabajan con conocimiento y usaron GPT-4 en tareas dentro de su alcance
...
meta.home.title: kadabra. Talleres prácticos de IA para equipos en Costa Rica
meta.home.desc: Talleres de IA de medio día, prácticos, para equipos en Costa Rica. Con el trabajo real de ustedes, con las herramientas que ya usan y sin nada que comprar después.
meta.work.title: El taller: IA sin cortina de humo. kadabra
meta.work.desc: Medio día, siete momentos y el trabajo de ustedes sobre la mesa. Lo que de verdad pasa en un taller de kadabra.
meta.learn.title: Más información: los números detrás del taller. kadabra
meta.learn.desc: Cuatro números explican por qué kadabra enseña así. Cada uno enlaza al estudio del que salió.
